...
load("~/R/transit_bookdown2/GET_url_test.RData")
load("~/R/transit_bookdown2/content_url_test.RData")
load("~/R/transit_bookdown2/final_url_test.RData")
load("~/R/transit_bookdown2/json_url_test.RData")

load("~/R/transit_bookdown2/googleway_raw_data.RData")

load("~/R/transit_bookdown2/philly_300_points.RData")
load("~/R/transit_bookdown2/GET_url_test.RData")


load("~/R/transit_bookdown2/aplay_PH.RData")
load("~/R/transit_bookdown2/aplay_DC.RData")
load("~/R/transit_bookdown2/aplay_NY.RData")
